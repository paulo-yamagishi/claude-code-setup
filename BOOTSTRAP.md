...
**YOU ARE READING THIS AS CLAUDE CODE.** Execute this bootstrap sequence now.

This file guides you through an interactive setup that auto-configures Claude Code for the current project. Work through each phase sequentially, asking the user for input only where marked.
...
## Additional Guidelines for Claude Executing This Bootstrap
